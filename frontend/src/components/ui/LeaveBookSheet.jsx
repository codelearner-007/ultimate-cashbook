      ...
      <View style={s.anchor} pointerEvents="box-none">
        <Animated.View style={[s.sheet, { backgroundColor: C.card, transform: [{ translateY: slideY }] }]}>
          ...
          <View style={s.headerRow}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={[s.title, { color: C.text, fontFamily: Font.bold }]}>Leave Book</Text>
              <Text style={[s.subtitle, { color: C.danger, fontFamily: Font.medium }]}>
                This can only be undone by the owner
              </Text>
            </View>
          </View>
          ...
          <View style={s.btnRow}>
            ...
            <TouchableOpacity
              style={[s.btn, s.btnLeave, { backgroundColor: C.danger, opacity: isLoading ? 0.6 : 1 }]}
